...
package com.stegner.common.ui.base
...
/**
 * Base fragment to standardize and simplify initialization for a component.
 *
...
abstract class BaseFragment<B: ViewDataBinding, M: ViewModel>(@LayoutRes private val layoutId: Int) : Fragment() {
    ...
    /**
     * Reference to variables from view to viewModel
     */
    ...
    /**
     * Called to have the fragment instantiate its user interface for the view.
     *
     * @param inflater The LayoutInflater object that can be used to inflate any views in the fragment.
     * @param container if non-null, this is the parent view that fragment should be attached to. The fragment should not
     * be able to add the view itself, but  this can be used to generate the LayoutParams of  the view.
    ...
    /**
     * Return [AppCompatActivity] this fragment is currently associated with.
     *
